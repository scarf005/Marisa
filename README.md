...
> [!IMPORTANT]
>
> Releases for steam workshop are halted due to mod uploader not recognizing flatpak steam instance. Please [download releases from github](https://github.com/scarf005/Marisa/releases) manually until then.
